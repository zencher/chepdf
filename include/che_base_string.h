...
{
public:
    ByteString( Allocator * pAllocator = nullptr ) : BaseObject(pAllocator), _data(nullptr) {}
	...
	ByteString( char ch, Allocator * pAllocator = nullptr );
	ByteString( char const * pstr, size_t length = 0, Allocator * pAllocator = nullptr );
...
{
public:
    WideString( Allocator * pAllocator = nullptr ) : BaseObject(pAllocator), _data(nullptr) {}
	...
	WideString( wchar_t wch, Allocator * pAllocator = nullptr );
	WideString( wchar_t const * pstr, size_t nStrSize = 0, Allocator * pAllocator = nullptr );
